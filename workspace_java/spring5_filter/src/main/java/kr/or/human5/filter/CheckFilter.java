...
//		response.setContentType("text/html; charset=utf-8");
		...
		// "/login".equals(servletPath) 써줘야지 로그인에 들어갈수있고
		// loginCheck".equals(servletPath) 를 적어줘야지 로그인후 컨트롤러로 갈수있다.
	...
	private boolean isExclude(String servletPath) {
		if ("/login".equals(servletPath) || "/loginCheck".equals(servletPath)
				|| servletPath.indexOf("/resources/") != -1 || servletPath.startsWith("/resources/")) {
			return true;
		} else {
			return false;
		}
