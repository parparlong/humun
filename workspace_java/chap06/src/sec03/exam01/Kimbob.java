...
//	String[] menu; //메뉴들
//	int[] price; // 메뉴와 수서를 맞춰서 관리하는 
	ArrayList menu; //메뉴들
	ArrayList price; // 메뉴와 수서를 맞춰서 관리하는 
...
//		for(int i = 0 ; i < this.menu.size(); i++) {
	 ...
	 * 영수증 출력
	 * 
	 * @parameter int index 메뉴 번호, int count 개수
	 * @return void
	 */
	...
	void plus(String a, int b) {
		this.menu.add(a);
		this.price.add(b);
		System.out.println(a+"를 추가하였습니다.");
		System.out.println(b+"를 추가하였습니다.");
	}
